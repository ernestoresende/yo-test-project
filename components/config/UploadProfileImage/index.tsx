...
export const UploadProfileImage = React.forwardRef<HTMLDivElement>(({ ...props }, componentRef) => {
            ...
            <React.Fragment>
              {isImagePresent ? (
                <S.ImagePresentWrapper>
                  ...
                  <Spacer size={12} />
                  <Text center>
                    Essa é foto que outros verão quando você juntar-se à uma sala. Caso queira mudar
                    a foto, clique em <b>Mudar Foto</b>.
                  </Text>
                  <Spacer size={32} />
                  <Image
                    src={imageFile}
